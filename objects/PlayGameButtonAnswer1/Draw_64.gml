...
if(global.countdown == 0){	/// @DnDAction : YoYo Games.Drawing.Draw_Self
	...
	/// @DnDHash : 4FAD2E6E
	/// @DnDParent : 29EB2E3A
	/// @DnDArgument : "x" "display_get_width() / 5"
	/// @DnDArgument : "y" "room_height / 1.15"
	/// @DnDArgument : "yscale" "1.5"
	/// @DnDArgument : "sprite" "Button"
	/// @DnDSaveInfo : "sprite" "Button"
	draw_sprite_ext(Button, 0, display_get_width() / 5, room_height / 1.15, 1, 1.5, 0, $FFFFFF & $ffffff, 1);

	/// @DnDAction : YoYo Games.Drawing.Draw_Value_Transformed
	/// @DnDVersion : 1
	/// @DnDHash : 02A061F3
	/// @DnDParent : 29EB2E3A
	/// @DnDArgument : "x" "display_get_width() / 4.9"
